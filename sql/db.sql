...
insert into produits (ID_Produit, NomProduit, Description, Prix, StockDisponible, ID_Categorie) VALUES (102, 'Collier en or blanc et perle noire', 'Collier en or blanc 18 carats avec une perle noire de Tahiti. Un bijou élégant et intemporel pour une soirée spéciale.', 1399.99, 7, 1),
(103, 'Bague en argent et topaze mystique', 'Bague en argent sterling 925 sertie de topazes mystiques de qualité AAA. Un bijou unique pour les amateurs de pierres précieuses.', 899.99, 10, 1)
