...
DELIMITER ;
---------------------------------------------------------------------------------------------------
/*     faire un nouveau ordre / Ajouter nouvelle Commande   */ 
...
---les nouvelles commandes insérées dans la table Commandes-raison: bijoux demande une assurance lors de l'envoie par poste 
